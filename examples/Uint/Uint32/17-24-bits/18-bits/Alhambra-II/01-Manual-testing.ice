{
    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## Uint32-18bit Manual testing",
            "readonly": true
          },
          "position": {
            "x": 368,
        ...
        {
          "id": "f701e3d4-39b2-47fa-afb2-ccccc930425d",
          "type": "773c5958c21ec18fdc891694ee42998bf80c92fc",
          "position": {
            "x": 544,
            "y": 56
          },
        ...
        {
          "id": "6c5c3bc7-08ba-47d0-a6dc-930c7a9b3f53",
          "type": "2490d9176c217c9ff6961025f487d0c50e271c3d",
          "position": {
            "x": 344,
            "y": 56
          },
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "6c5c3bc7-08ba-47d0-a6dc-930c7a9b3f53",
        ...
        {
          "source": {
            "block": "f701e3d4-39b2-47fa-afb2-ccccc930425d",
        ...
        },
        {
          "source": {
            "block": "6c5c3bc7-08ba-47d0-a6dc-930c7a9b3f53",
            "port": "8415a9d3-8106-4268-b951-00591ed46c11"
          },
          "target": {
            "block": "f701e3d4-39b2-47fa-afb2-ccccc930425d",
            "port": "3af3bf13-22af-4552-a770-1cd6c854cb5f"
          },
          "size": 18
        }
      ]
  ...
  "dependencies": {
    ...
    "773c5958c21ec18fdc891694ee42998bf80c92fc": {
      "package": {
        "name": "UINT32-18bit-verilog",
        "version": "0.1",
        "description": "UINT32-18bit-verilog:  Extend a 18-bit unsigned integer to 32-bits. Verilog implementation ",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "3af3bf13-22af-4552-a770-1cd6c854cb5f",
              "type": "basic.input",
              "data": {
                "name": "i",
                "virtual": true,
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "3af3bf13-22af-4552-a770-1cd6c854cb5f",
                "port": "out"
              },
              "target": {
                "block": "060b73c2-8fae-4f64-8db2-c8335f464d4c",
    ...
    "2490d9176c217c9ff6961025f487d0c50e271c3d": {
      "package": {
        "name": "Copy-18-verilog",
        "version": "0.2",
        "description": "Copy-18: Copy the input wire twice and generate a 18 bits Bus output (Verilog implementation)",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "8415a9d3-8106-4268-b951-00591ed46c11",
              "type": "basic.output",
              "data": {
                "name": "",
                "virtual": true,
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "8415a9d3-8106-4268-b951-00591ed46c11",
                "port": "in"
              },
              "size": 18
            }
