{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "9f13b6a8-878a-4aa0-abcf-09429c1458ad",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "range": "[7:0]",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# BUS-8: Manual testing with LEDs\n\nTurn on all the LEDs",
            "readonly": true
          },
          "position": {
            "x": 400,
        ...
        {
          "id": "797227df-bd16-4ee3-a92d-661c8168d723",
        ...
        {
          "id": "ac20e290-b36e-45e3-9d11-287f47477420",
          "type": "fa9a0689f7fed90ad05debf912a74bc3c3302c90",
          "position": {
            "x": 680,
            "y": -192
          },
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "797227df-bd16-4ee3-a92d-661c8168d723",
            "port": "c0fb4784-5e8c-4f41-9f4b-6daa2e9e03a4"
          }
        },
        {
          "source": {
            "block": "ac20e290-b36e-45e3-9d11-287f47477420",
            "port": "3c23833d-2c64-4e59-b81b-468d4d736908"
          },
          "target": {
            "block": "9f13b6a8-878a-4aa0-abcf-09429c1458ad",
            "port": "in"
          },
          "size": 8
        },
        {
          ...
          "target": {
            "block": "ac20e290-b36e-45e3-9d11-287f47477420",
            "port": "b1a7edc7-490e-480f-b0cd-549a04c3aabc"
          },
          "size": 8
        }
      ]
  ...
  "dependencies": {
    ...
    "fa9a0689f7fed90ad05debf912a74bc3c3302c90": {
      "package": {
        "name": "Bus8",
        "version": "0.1",
        "description": "Bus8: Eight bits plain Bus",
      ...
      "design": {
        "graph": {
          "blocks": [
            {
              "id": "b1a7edc7-490e-480f-b0cd-549a04c3aabc",
              "type": "basic.input",
              "data": {
                "name": "",
                "range": "[7:0]",
            ...
            {
              "id": "3c23833d-2c64-4e59-b81b-468d4d736908",
              "type": "basic.output",
              "data": {
                "name": "",
                "range": "[7:0]",
          ...
          "wires": [
            {
              "source": {
                "block": "b1a7edc7-490e-480f-b0cd-549a04c3aabc",
                "port": "out"
              },
              "target": {
            ...
            },
            {
              ...
              "target": {
                "block": "3c23833d-2c64-4e59-b81b-468d4d736908",
                "port": "in"
              },
              "size": 8
            }
