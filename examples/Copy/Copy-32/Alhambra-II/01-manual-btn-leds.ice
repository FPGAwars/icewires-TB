{
    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Copy-32: Manual testing with one pushbutton and LEDs\n\nWhen the button is pressed, the LEDs are turned on",
            "readonly": true
          },
          "position": {
            "x": 344,
        ...
        {
          "id": "b66b2ec6-8d89-4d2c-999d-550a78f2b255",
          "type": "7ccaa5448156afa79d674038d990bb6360a020ad",
          "position": {
            "x": 528,
            "y": -152
          },
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "b66b2ec6-8d89-4d2c-999d-550a78f2b255",
        ...
        },
        {
          "source": {
            "block": "b66b2ec6-8d89-4d2c-999d-550a78f2b255",
            "port": "7ec76f79-cabf-425f-9e58-f88d45989dbe"
          },
          "target": {
            "block": "a62e4a80-5e4d-4786-8935-99bdabe6438a",
  ...
  "dependencies": {
    ...
    "7ccaa5448156afa79d674038d990bb6360a020ad": {
      "package": {
        "name": "Copy-32-verilog",
        "version": "0.2",
        "description": "Copy-32: Copy the input wire twice and generate a 32 bits Bus output (Verilog implementation)",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "7ec76f79-cabf-425f-9e58-f88d45989dbe",
              "type": "basic.output",
              "data": {
                "name": "",
                "virtual": true,
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "7ec76f79-cabf-425f-9e58-f88d45989dbe",
                "port": "in"
              },
              "size": 32
            }
