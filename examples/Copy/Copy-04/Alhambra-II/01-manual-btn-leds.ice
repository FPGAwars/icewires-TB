{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "7ea3f74c-81f1-4776-9644-8719f1df0643",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "range": "[3:0]",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Copy-4: Manual testing with one pushbutton and LEDs\n\nWhen the button is pressed, the LEDs are turned on",
            "readonly": true
          },
          "position": {
            "x": 616,
        ...
        {
          "id": "cfc01058-35e0-48d3-bc57-f7540f69ad0f",
          "type": "2bd7444d5d5670b29d4bfaa160ba72ee16926b61",
          "position": {
            "x": 784,
            "y": -168
          },
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "cfc01058-35e0-48d3-bc57-f7540f69ad0f",
        ...
        },
        {
          ...
          "target": {
            "block": "7ea3f74c-81f1-4776-9644-8719f1df0643",
            "port": "in"
          },
          "size": 4
        }
  ...
  "dependencies": {
    "2bd7444d5d5670b29d4bfaa160ba72ee16926b61": {
      "package": {
        "name": "Copy-4-verilog",
        "version": "0.2",
